# 👋 Hello, moi c'est Lucas Martinie de Maisonneuve

💻 Développeur passionné par le développement logiciel et les nouvelles technologies.

🚀 J'aime construire des projets utiles, résoudre des problèmes techniques et apprendre en continu.
...
<sub>Stack: C++ • Qt • PostgreSQL • Bcrypt • Docker • Chiffrement</sub><br>
<sub><i>2025 — 2026</i></sub>
...
<sub>Stack: Java • SpringBoot • MySQL • POO • MVC</sub><br>
<sub><i>2025</i></sub>
...
<sub>Stack: Python • MySQL • Chiffrement</sub><br>
<sub><i>2024</i></sub>
...
<sub>Stack: C++ • Raylib • SDL • POO</sub><br>
<sub><i>2024</i></sub>
...
<sub>Stack: Python • Pygame • POO</sub><br>
<sub><i>2024</i></sub>
...
<sub>Stack: JavaScript • HTML • CSS • LocalStorage</sub><br>
<sub><i>2024</i></sub>
...
### 💻 Langages
![Java](https://img.shields.io/badge/Java-red?logo=openjdk) ![C](https://img.shields.io/badge/C-blue?logo=c) ![C++](https://img.shields.io/badge/C++-blue?logo=cplusplus) ![Python](https://img.shields.io/badge/Python-yellow?logo=python) ![JavaScript](https://img.shields.io/badge/JavaScript-yellow?logo=javascript) ![HTML5](https://img.shields.io/badge/HTML5-orange?logo=html5) ![CSS3](https://img.shields.io/badge/CSS3-blue?logo=css3)

### ⚙️ Frameworks, DevOps & Outils
![Spring Boot](https://img.shields.io/badge/SpringBoot-green?logo=springboot) ![React](https://img.shields.io/badge/React-black?logo=react) ![JUnit](https://img.shields.io/badge/JUnit-red?logo=junit5) ![Docker](https://img.shields.io/badge/Docker-blue?logo=docker) ![Postman](https://img.shields.io/badge/Postman-orange?logo=postman) ![Sqitch](https://img.shields.io/badge/Sqitch-grey) ![Figma](https://img.shields.io/badge/Figma-purple?logo=figma) ![Jira](https://img.shields.io/badge/Jira-blue?logo=jira) ![GoogleTest](https://img.shields.io/badge/GoogleTest-green)

### 🗄️ Bases de données
![MySQL](https://img.shields.io/badge/MySQL-blue?logo=mysql) ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-blue?logo=postgresql) ![MongoDB](https://img.shields.io/badge/MongoDB-green?logo=mongodb)
...
💼 [LinkedIn](https://www.linkedin.com/in/lucas-martinie-de-maisonneuve-2349892b3/)  
📧 Email : lucas.martinie@gmail.com  
